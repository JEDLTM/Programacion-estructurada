...
DESCRIPCION: Elaborar una calculadora que realice la suma, resta y multiplicación de 2 matrices. Las condiciones son la siguientes:
...
void editarValor(int matriz[10][10], int dimension) {
...
void borrarValor(int matriz[10][10], int dimension) {
    int fila, columna;
...
int main() {
    ...
    if (dimension < 2 || dimension > 10) {
        ...
        return 1;  // Sale si la dimension no es valida
    }
        ...
        switch (opcion) {
            ...
            case 7:
                ...
                if (matrizSeleccionada == 1) {
                    editarValor(matriz1, dimension);
                } else {
                    editarValor(matriz2, dimension);
                }
                break;
            case 8:
                seleccionarMatriz(matrizSeleccionada);
                if (matrizSeleccionada == 1) {
                    borrarValor(matriz1, dimension);
                } else {
                    borrarValor(matriz2, dimension);
                }
                break;
            case 9:
                seleccionarMatriz(matrizSeleccionada);
